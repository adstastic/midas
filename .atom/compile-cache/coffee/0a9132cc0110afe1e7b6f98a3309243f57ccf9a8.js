(function() {
  ...
  module.exports = BrowserPlusView = (function(_super) {
    ...
    BrowserPlusView.prototype.initialize = function() {
      ...
      this.htmlv[0].addEventListener("page-favicon-updated", function(e) {
        debugger;
      });
      this.htmlv[0].addEventListener("page-title-set", function(e) {
        debugger;
      });
    ...
    BrowserPlusView.prototype.liveReload = function() {
      return this.htmlv[0].executeJavaScript("location.href = '" + this.model.uri + "'");
    };
    ...
    BrowserPlusView.prototype.addHistory = function() {
      var histToday, history, obj, today, todays, url, _ref1;
      ...
      return (_ref1 = this.model.browserPlus.histView) != null ? _ref1.htmlv[0].send('updHist', this.model.browserPlus.history) : void 0;
    };
